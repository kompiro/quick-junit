...
public class Messages extends NLS {
	private static final String BUNDLE_NAME = "junit.extensions.eclipse.quick.process.internal.messages"; //$NON-NLS-1$
	...
	public static String ProcessKey_DETAIL_DESCRIPTION;
	public static String ProcessKey_SUMMARY_DESCRIPTION;
